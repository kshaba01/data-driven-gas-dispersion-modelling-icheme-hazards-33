...
ax.set_title('XRT Comparison of Measured/Predicted for transformed target units')
plt.show()
...
ax.set_title('XRT Comparison of Measured/Predicted for original target units')
ax.set_xlabel('Measured')
ax.set_ylabel('Predicted')
plt.show()
...
plt.title("XRT First 600 test cases")
plt.show()


plt.plot(y_train)
plt.plot(model.predict(X_train))
plt.title("XRT All training cases")
plt.show()
...
#Compare with output for the API
X_test[0]
...
#test saved model
loaded_model = load('model_xrt.joblib') 
